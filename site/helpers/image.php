...
if ($template) {
	define('CURRENT_DIR',		realpath($baseDir . '/components/com_advportfolio/templates/' . $template . '/images'));
} else {
	define('CURRENT_DIR',		realpath($baseDir . '/images/advportfolio/images'));
}
define('CACHE_DIR_NAME',		'/imagecache/');
define('CACHE_DIR',				$baseDir . '/images/advportfolio/' . CACHE_DIR_NAME);
