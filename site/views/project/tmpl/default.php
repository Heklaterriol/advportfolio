...
$hasContent = $this->item->description != '' && $this->params->get('show_description', 1);
...
<?php if ($hasMedia && $hasContent) : ?>
	<?php if ($this->params->get('description_position') == 'top' || $this->params->get('description_position') == 'bottom') : ?>
		...
		<?php endif; ?>
		<div><?php echo $this->loadTemplate('media'); ?></div>
		<?php if ($this->params->get('description_position') == 'bottom') : ?>
			<div><?php echo $this->loadTemplate('description'); ?></div>
		<?php endif; ?>
	<?php else : ?>
		<?php if ($this->params->get('description_position') == 'left') : ?>
			<div class="span<?php echo $this->params->get('description_width'); ?>"><?php echo $this->loadTemplate('description'); ?></div>
		<?php endif; ?>
		<div class="span<?php echo (12 - $this->params->get('description_width')); ?>"><?php echo $this->loadTemplate('media'); ?></div>
