 ...
 * @since       3.3
 */
class AdvPortfolioRouter extends JComponentRouterBase {
	/**
	...
	public function build(&$query) {
		...
		$menu = $app->getMenu();
		$params = JComponentHelper::getParams('com_advportfolio');
		...
		if (isset($view) and ($view == 'category' or $view == 'project')) {
			if ($mId != (int) $query['id'] || $mView != $view) {
				...
				$menuCatid = $mId;
				$categories = JCategories::getInstance('AdvPortfolio');
	...
	public function parse(&$segments) {
		...
		$category = JCategories::getInstance('AdvPortfolio')->get($id);
