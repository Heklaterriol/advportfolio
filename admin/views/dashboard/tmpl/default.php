	...
	<div class="span6">
		<div class="well well-small">
			<div class="module-title nav-header">
				<?php echo JText::_('COM_ADVPORTFOLIO_SUBMENU_DASHBOARD'); ?>
			</div>
...
//					$this->_quickIcon('index.php?option=com_advportfolio&view=tags', 'icon-64-tags.png', 'COM_ADVPORTFOLIO_SUBMENU_TAGS');
					$this->_quickIcon('index.php?option=com_config&view=component&component=com_advportfolio&return=' . urlencode(base64_encode(JUri::getInstance())), 'icon-64-config.png', 'COM_ADVPORTFOLIO_SUBMENU_CONFIG');
					?>
				</div>
			</div>
		</div>
