...
<div class="well clearfix" style="padding-bottom: 10px; padding-top: 10px; margin-bottom: 10px;">
	<div class="span6">
		<fieldset title="<?php echo JText::_('COM_ADVPORTFOLIO_UPLOAD_SELECT_IMAGE'); ?>">
			<legend>
				<?php echo JText::_('COM_ADVPORTFOLIO_UPLOAD_SELECT_IMAGE'); ?>
			</legend>
			...
			<button class="btn btn-primary" type="button" onclick="Joomla.submitform('imagehandler.upload');">
				<i class="icon-upload icon-white"></i> <?php echo JText::_('COM_ADVPORTFOLIO_UPLOAD_BTN_LABEL'); ?>
			</button>
			<p>
				<span class="muted small">
					<?php echo JText::_('COM_ADVPORTFOLIO_UPLOAD_VALID_FILE_TYPE'); ?>
	...
	<div class="span6">
		<fieldset title="<?php echo JText::_('COM_ADVPORTFOLIO_FTP_TITLE'); ?>">
			<legend>
				<?php echo JText::_('COM_ADVPORTFOLIO_FTP_TITLE'); ?>
			</legend>
			<?php echo JText::_('COM_ADVPORTFOLIO_FTP_DESC'); ?>
