...
<form action="<?php echo JRoute::_('index.php?option=com_advportfolio&view=projects&layout=modal&tmpl=component&function=' . $function . '&' . JSession::getFormToken() . '=1');?>" method="post" name="adminForm" id="adminForm" class="form-inline">
	<fieldset class="filter clearfix">
		<div class="btn-toolbar">
			<div class="btn-group pull-left">
				...
				<input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" size="30" title="<?php echo JText::_('COM_ADVPORTFOLIO_FILTER_SEARCH_DESC'); ?>" />
			</div>
			<div class="btn-group pull-left">
			...
			<input onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('0', '<?php echo $this->escape(addslashes(JText::_('COM_ADVPORTFOLIO_SELECT_A_PROJECT'))); ?>', null, null);" class="btn" type="button" value="<?php echo JText::_('COM_ADVPORTFOLIO_NONE'); ?>" />
		...
		<div class="filters">
			...
			<select name="filter_category_id" class="input-medium" onchange="this.form.submit()">
				<option value=""><?php echo JText::_('JOPTION_SELECT_CATEGORY');?></option>
				<?php echo JHtml::_('select.options', JHtml::_('category.options', 'com_advportfolio'), 'value', 'text', $this->state->get('filter.category_id'));?>
			</select>
