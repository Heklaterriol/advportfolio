		...
		<thead>
			<tr>
				<th width="1%" class="nowrap center hidden-phone">
					<?php echo LayoutHelper::render('joomla.html.grid.sort', ['title' => '<i class="icon-menu-2"></i>', 'field' => 'a.ordering', 'direction' => $listDirn, 'order' => $listOrder, 'default' => 'asc', 'tip' => 'JGRID_HEADING_ORDERING']); ?>
				</th>
				<th width="1%" class="hidden-phone">
					<input type="checkbox" name="checkall-toggle" value="" title="<?php echo Text::_('JGLOBAL_CHECK_ALL'); ?>" onclick="Joomla.checkAll(this)" />
				</th>
				<th width="1%" style="min-width:55px" class="nowrap center">
					<?php echo LayoutHelper::render('joomla.html.grid.sort', ['title' => 'JSTATUS', 'field' => 'a.state', 'direction' => $listDirn, 'order' => $listOrder]); ?>
				</th>
				<th class="title">
					<?php echo LayoutHelper::render('joomla.html.grid.sort', ['title' => 'JGLOBAL_TITLE', 'field' => 'a.title', 'direction' => $listDirn, 'order' => $listOrder]); ?>
				</th>
				<th width="5%">
					<?php echo LayoutHelper::render('joomla.html.grid.sort', ['title' => 'JGRID_HEADING_ACCESS', 'field' => 'a.access', 'direction' => $listDirn, 'order' => $listOrder]); ?>
				</th>
				<th width="10%">
					<?php echo LayoutHelper::render('joomla.html.grid.sort', ['title' => 'JAUTHOR', 'field' => 'a.created_by', 'direction' => $listDirn, 'order' => $listOrder]); ?>
				</th>
				<th width="5%">
					<?php echo LayoutHelper::render('joomla.html.grid.sort', ['title' => 'JDATE', 'field' => 'a.created', 'direction' => $listDirn, 'order' => $listOrder]); ?>
				</th>
				<th width="5%">
					<?php echo LayoutHelper::render('joomla.html.grid.sort', ['title' => 'JGRID_HEADING_LANGUAGE', 'field' => 'a.language', 'direction' => $listDirn, 'order' => $listOrder]); ?>
				</th>
				<th width="1%">
					<?php echo LayoutHelper::render('joomla.html.grid.sort', ['title' => 'JGRID_HEADING_ID', 'field' => 'a.id', 'direction' => $listDirn, 'order' => $listOrder]); ?>
				</th>
			</tr>
		</thead>
		<tbody>
		...
		?>
			<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
				...
				<td class="center hidden-phone">
					<?php echo LayoutHelper::render('joomla.html.grid.id', ['i' => $i, 'id' => $item->id]); ?>
				</td>
				<td class="center">
					<?php echo LayoutHelper::render('joomla.html.jgrid.published', ['value' => $item->state, 'i' => $i, 'prefix' => 'projects.', 'canChange' => $canChange]); ?>
				</td>
