...
<form action="<?php echo JRoute::_('index.php?option=com_advportfolio&view=projects'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif; ?>
	<div id="filter-bar" class="btn-toolbar">
		<div class="filter-search btn-group pull-left">
			...
			<input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_ADVPORTFOLIO_SEARCH_IN_TITLE'); ?>" placeholder="<?php echo JText::_('COM_ADVPORTFOLIO_SEARCH_IN_TITLE'); ?>" />
		</div>
			...
			<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
				...
				<td class="nowrap has-context">
					<div class="pull-left">
						...
						<?php if ($canEdit) : ?>
						<a href="<?php echo JRoute::_('index.php?option=com_advportfolio&task=project.edit&id=' . (int) $item->id); ?>">
